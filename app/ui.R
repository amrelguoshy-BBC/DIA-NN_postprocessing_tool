  ...
  tabsetPanel(
        ...
        column(width = 5,
          wellPanel(
            ...
            radioButtons("lib_data_source", "Choose Library data source:",
             choices = c("Sample Lib Data" = "lib_sample",
                         "Upload Lib from Computer" = "lib_upload",
                         "Download Lib from Google Drive" = "lib_gdrive"),
             selected = "lib_upload"),
            ...
            fluidRow(
              ...
              choices = c("Sample Diann Data" = "diann_sample",
                         "Upload Diann data from Computer" = "diann_upload",
                         "Download Diann data from Google Drive" = "diann_gdrive"),
             selected = "diann_upload"),
    ...
    tabPanel("Library Enhancement", icon = icon("cogs"), value = "tab3",
      fluidRow(
        column(width = 4,
          wellPanel(
            h4(icon("flask"), "Library 1 Configuration"),
            radioButtons("lib1_data_source", "Choose Library1 data source:",
             choices = c("Sample Lib1 Data" = "lib1_sample",
                         "Upload Lib1 from Computer" = "lib1_upload",
                         "Download Lib1 from Google Drive" = "lib1_gdrive"),
             selected = "lib1_upload"),
             uiOutput("file_ui_lib1"),
             selectInput("lib1_type", "Library Type", 
                      choices = c("DIA", "DDA" ),
                      width = "100%"),
           )
         ),
         column(width = 4,
          wellPanel(
            h4(icon("flask"), "Library 2 Configuration"),
            radioButtons("lib2_data_source", "Choose Library2 data source:",
             choices = c("Sample Lib2 Data" = "lib2_sample",
                         "Upload Lib2 from Computer" = "lib2_upload",
                         "Download Lib2 from Google Drive" = "lib2_gdrive"),
             selected = "lib2_upload"),
             uiOutput("file_ui_lib2"),
             selectInput("lib2_type", "Library Type", 
                      choices = c("DIA", "DDA" ),
                      width = "100%"),
           )
         ),
      ...
      fluidRow(
        column(width = 4,
          wellPanel(
            h4(icon("flask"), "cosine similarity Library 1 Configuration"),
            radioButtons("cos_sim_lib1_data_source", "Choose cosine similarity Library1 data source:",
             choices = c("Sample cos_sim Lib1 Data" = "cos_sim_lib1_sample",
                         "Upload cos_sim Lib1 from Computer" = "cos_sim_lib1_upload",
                         "Download cos_sim Lib1 from Google Drive" = "cos_sim_lib1_gdrive"),
            selected = "cos_sim_lib1_upload"),
            uiOutput("file_ui_cos_sim_lib1"),
        ...
        column(width = 4,
          wellPanel(
            h4(icon("flask"), "cosine similarity Library 2 Configuration"),
            radioButtons("cos_sim_lib2_data_source", "Choose cosine similarity Library2 data source:",
             choices = c("Sample cos_sim Lib2 Data" = "cos_sim_lib2_sample",
                         "Upload cos_sim Lib2 from Computer" = "cos_sim_lib2_upload",
                         "Download cos_sim Lib2 from Google Drive" = "cos_sim_lib2_gdrive"),
             selected = "cos_sim_lib2_upload"),
            uiOutput("file_ui_cos_sim_lib2"),
